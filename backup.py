...
class ConvLayer(torch.nn.Module):
    ...
    def __init__(self, in_c, out_c, kernel_size, stride):
        ...
        self.reflection = torch.nn.ReflectionPad2d(padding)
        self.conv = torch.nn.Conv2d(in_c, out_c, kernel_size=kernel_size, stride=stride)
...
class Upsampleconv(torch.nn.Module): 
    ...
    def __init__(self, in_c, out_c, kernel_size, stride, upsample=None):
...
class ResidualBlock(torch.nn.Module):
    ...
    def __init__(self,ch):
        ...
        self.norm1 = torch.nn.InstanceNorm2d(ch, affine=True)
        self.conv2 = ConvLayer(ch, ch, kernel_size=3, stride=1)
        self.norm2 = torch.nn.InstanceNorm2d(ch, affine=True)
